...
class App {
    public static void main(String[] args) throws ClassNotFoundException {
        try {
            ...
            try {
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/javalab", "root", "Bvssl22");
                ...
                while (true) {
                    ...
                    switch (n) {
                        case 1:
                            Boolean out = stmt.execute(
                                    "create table " + table + "(id int primary key, name varchar(20) not null)");
                            if (!out) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            System.out.print("Enter ID of the tuple to be deleted:");
                            String did = sc.next();
                            stmt.executeUpdate("delete from " + table + " where id = " + did);
                            break;

                        case 5:
                            System.out.println("Enter ID of the tuple to be updated:");
                            String uid = sc.next();
